package com.asiainfo.ocdp.flume.source.socket;
 ...
 */
public class SocketSource extends AbstractSource implements Configurable,PollableSource {
    private final static Logger logger = Logger.getLogger(SocketSource.class);
